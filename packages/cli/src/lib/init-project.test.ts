...
describe("initProject", () => {
  ...
  it("copies generic harness docs while excluding monorepo boilerplate docs", () => {
    const sourceDir = makeTempDir("tstack-init-source-");
    ...
    try {
      ...
      writeFileSync(join(templatesDir, "default", "AGENTS.md"), "# Agent Guidance - MyApp");
      writeFileSync(join(templatesDir, "default", "docs", "context.md"), "# MyApp Context");
      writeFileSync(join(templatesDir, "default", "docs", "coding-standards.md"), "pnpm test");

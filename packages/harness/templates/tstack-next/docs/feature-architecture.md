...
Use this file when adding or changing application structure in this application.

This starter uses Next.js App Router plus feature modules under `src/features/`. Generic engineering doctrine stays in `docs/engineering/`; this file only documents the concrete app layout.

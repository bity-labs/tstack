...
This starter uses Better Auth for email/password, Email OTP, GitHub OAuth, Twitter OAuth, and SIWE (Sign In With Ethereum). Middleware is private by default. Polar customers are created on signup through the Polar Better Auth plugin.

...
This file documents request-time protection for pages, queries, API routes, and middleware. All patterns are authoritative for `apps/boilerplate`; do not roll your own session checks.

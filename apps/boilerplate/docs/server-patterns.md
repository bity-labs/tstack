---
title: Boilerplate Server Patterns
---

## Purpose

Use this file when writing server-side behavior in `apps/boilerplate`: RSC queries, server actions, API routes, error handling, email, and file upload flows.
